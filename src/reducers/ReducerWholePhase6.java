...
//	}
	...
	protected void reduce(LongWritable key, Iterable<IntWritable> allValues,
		...
		for (IntWritable values : allValues) {
			context.write(NullWritable.get(), new Text(key + Protocols.USER_WEIGHT + values));
		}
...
//			context.write(NullWritable.get(), new Text(Protocols.RECOMMEND_TO_NON_RECOMMENDED + valueKey.toString()));
//		}
//		//
//		// int count = 0;
