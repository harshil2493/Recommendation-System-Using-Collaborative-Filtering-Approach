	...
	public static void main(String[] args) throws IOException,
		...
		if (wholeDataScanningAndRecommendation) {
			...
			if (phase6) {
				...
				Job jobPhase6 = Job.getInstance(configurationPhase6,
...
//				jobPhase6.setNumReduceTasks(40);
				...
				jobPhase6.setSortComparatorClass(LongWritable.DecreasingComparator.class);
				...
				FileInputFormat.addInputPath(jobPhase6, new Path(outputOfPhase1));
